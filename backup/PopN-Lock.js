module.export = {
  ...
  colors: {
    ...
    "activityBarBadge.background": "#191B2A",
    "activityBarBadge.foreground": "#F2E5BC",

    "sideBar.background": "#191B2A",
    "sideBar.foreground": "#F2E5BC",
    "sideBarSectionHeader.background": "#191B2A",
    "list.activeSelectionBackground": "#191B2A",
    "list.inactiveSelectionBackground": "#191B2A",
    "list.hoverBackground": "#191B2A",
    "list.focusBackground": "#191B2A",
    ...
    "editorGroupHeader.tabsBackground": "#191B2A",

    focusBorder: "#3E588C",
    foreground: "#F2E5BC",

    "badge.background": "#191B2A",

    "statusBar.background": "#191B2A",
    "statusBar.noFolderBackground": "#191B2A",
    "statusBar.foreground": "#F2E5BC",

    "statusBar.border": "#455540",
    "statusBar.debuggingBackground": "#191B2A",
    "statusBar.debuggingForeground": "#F2E5BC",
    "statusBar.debuggingBorder": "#455540",

    "statusBar.noFolderForeground": "#F2E5BC",
    "statusBar.noFolderBorder": "#455540",

    "statusBarItem.activeBackground": "#191B2A",

    "statusBarItem.hoverBackground": "#191B2A",
    "statusBarItem.prominentBackground": "#191B2A",
    "statusBarItem.prominentHoverBackground": "#191B2A",

    "tab.activeForeground": "#F2E5BC",

    "input.background": "#191B2A",
    "input.border": "#272836",

    "editor.foreground": "#F2E5BC",
    "editor.background": "#191B2A",
    "editor.lineHighlightBackground": "#191B2A",
    "editorWidget.background": "#191B2A",

    "editor.selectionBackground": "#3E588C",
    "editor.inactiveSelectionBackground": "#191B2A",
    "editor.selectionHighlightBackground": "#1E384C",

    "editor.wordHighlightStrongBackground": "#191B2A",
    "editor.wordHighlightBackground": "#191B2A",

    "editorCursor.foreground": "#F2E5BC",

    "editor.findMatchBackground": "#191B2A",
    "editor.findMatchHighlightBackground": "#191B2A",
    "editor.findRangeHighlightBackground": "#191B2A",

    "peekViewEditor.background": "#191B2A",
    "peekViewResult.background": "#191B2A",
    "peekViewResult.selectionBackground": "#191B2A",
    "peekView.border": "#F2E5BC",

    "button.background": "#191B2A",
    "button.foreground": "#F2E5BC",

    "dropdown.background": "#191B2A",

    "extensionButton.prominentBackground": "#191B2A",

    "notification.background": "#191B2A",
    "notification.buttonBackground": "#191B2A",
    "notification.infoBackground": "#191B2A",
    "notification.warningBackground": "#191B2A",
    "notification.errorBackground": "#191B2A",

    "gitDecoration.modifiedResourceForeground": "#FABD2F",
    "gitDecoration.untrackedResourceForeground": "#8AE180",
    "gitDecoration.ignoredResourceForeground": "#268DD6",
    ...
    "terminal.background": "191B2A1"
  },

  tokenColors: [
    {
      scope: ["case-clause.expr"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["case-clause.expr "],
      settings: { foreground: "", fontStyle: "underline" }
    ...
    {
      scope: ["comment.line.triple-slash.directive"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["constant.other.email.link.underline.jsdoc"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["entity.name.function variable.language.this"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["entity.other.attribute-name.directive"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["invalid.illegal.syntax.jsdoc"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["keyword.operator.definiteassignment"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["keyword.operator.expression.in"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["keyword.operator.expression.infer"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["keyword.operator.expression.of"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["keyword.operator.expression.void"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["keyword.operator.type.modifier"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["meta.array-binding-pattern-variable"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["meta.assertion.look-behind.regexp"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["meta.assertion.negative-look-ahead.regexp"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["meta.assertion.negative-look-behind.regexp"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["meta.block"],
    ...
    {
      scope: ["meta.block punctuation.definition.block"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["meta.brace.angle"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["meta.definition.property entity.name.function"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["meta.definition.property variable.object.property"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["meta.definition.variable variable.other.readwrite"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["meta.enum.declaration"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["meta.example.jsdoc"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["meta.function-call punctuation.accessor.optional"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["meta.import-equals.external"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["meta.import-equals.internal"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["meta.import"],
    ...
    {
      scope: ["meta.indexer.declaration"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["meta.object-binding-pattern-variable"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["meta.object.member meta.object-literal.key"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["meta.parameter.object-binding-pattern"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["meta.paramter.array-binding-pattern"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["meta.return.type.arrow"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["meta.type.constructor keyword.control.new"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["meta.type.function.return"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["meta.type.function"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["meta.type.parameters punctuation.definition.typeparameters.end"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["meta.type.paren.cover"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["meta.type.tuple"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["meta.var-single-variable.expr"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["meta.var.expr"],
    ...
    {
      scope: ["punctuation.definition.bracket.angle.begin.jsdoc"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["punctuation.definition.bracket.angle.end.jsdoc"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["punctuation.definition.bracket.curly.begin.jsdoc"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["punctuation.definition.bracket.curly.end.jsdoc"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["punctuation.definition.bracket.square.begin.jsdoc"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["punctuation.definition.bracket.square.end.jsdoc"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["punctuation.definition.optional-value.end.bracket.square.jsdoc"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["punctuation.definition.section.case-statement"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["punctuation.definition.string.begin.jsdoc"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["punctuation.definition.string.end.jsdoc"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["punctuation.definition.tag.directive"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["punctuation.separator.label"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["punctuation.separator.pipe.jsdoc"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["storage.type.internaldeclaration"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["support.class.node"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["support.class.promise"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["support.class"],
    ...
    {
      scope: ["support.function.process"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["support.variable.property.target"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["switch-block.expr"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["switch-expression.expr"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["switch-statement.expr"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
      scope: ["TypeScript"],
    ...
    {
      scope: ["variable.other.constant.object.property"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["variable.other.description.jsdoc"],
      settings: { foreground: "", fontStyle: "underline" }
    },
    {
    ...
    {
      scope: ["case-clause.expr", "case-clause.expr ", "cast.expr"],
    ...
    {
      scope: ["invalid.illegal.newline", "invalid.illegal.syntax.jsdoc"],
      settings: { foreground: "#fff", fontStyle: "bold" }
    },
    {
      scope: [
